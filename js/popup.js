...
const worksData = {
  ...
  hinatabokko: {
    ...
    info: {
      ...
      points: "<br>安心して来店できる導線設計を意識し、WordPress（Contact Form 7）でお問い合わせフォームを実装しました。PC表示ではタイトル文字が縦書き表示になる等、レスポンシブデザインもこだわりました。"
    },
    ...
    steps: [

      {
        ...
        text: "シンプルで情報が伝わりやすい動線を意識しました。パソコン版では画像と文章を横並びにし、一段ずつ画像と文章の位置を入れ替えることで単調にならないよう工夫しました。またタイトルだけ縦書きにすることでレトロな雰囲気を演出しました"
      },
      {
        title: "デザインカンプ作成",
        img: "./images/hinatabokko-design-comp.png",
        text: "ターゲットである若い女性が親しみやすいデザインにするために温かみのある色味、丸みのある枠をメインに構成ました。また、コントラスト、彩度を下げた画像を使用することで、古民家のどこか懐かしいレトロな雰囲気を表現しました。"
      },
      {
        title: "Web制作・コーディング",
        img: "./images/hinatabokko-coding.png",
        text: "来店へのハードルを下げ、ほしい情報がワンクリックで見つかるコーディングを意識しました。アクセスではgooglemapを埋め込むことで迷うリスクを減らしました。運用面でも活用がしやすいよう、WordPress（Contact Form 7）を利用し、お問い合わせ内容がメールで送信される設定を行いました。"
      }
    ],
  ...
  sydney: {
    ...
    steps: [
      ...
      {
        title: "Web制作・コーディング",
        img: "./images/sydney-coding.png",
        text: "レスポンシブ対応の練習で制作しました。スマートフォン版ではスライドを自動、パソコン版では手動にすることで目線が散らばるのを防ぎました。固定headerの背景色が同化して見えづらかったため、スクロールしてheader部分を通り過ぎたらブラウンに変化することで視認性を上げました。"
      }
    ],
  ...
  ginrintei: {
    ...
    steps: [
      ...
      {
        title: "ワイヤーフレーム作成",
        img: "./images/ginrintei-wireframe.png",
        text: "和風フォントを見出しに使用することで高級感を演出し、ターゲットを絞る工夫をしました。情報の並び順を変えた２パターンを提案するため、２種類のワイヤーフレームと解説資料を合わせて制作、どちらがイメージに合っているか確認しやすくしました。"
  ...
  kazukiumeda: {
    ...
    steps: [
      ...
      {
        title: "ワイヤーフレーム作成",
        img: "./images/kazukiumeda.png",
        text: "スクロール疲れによる離脱率を防ぐため、詳細はアコーディオンで開く仕様にしページ全体が長くなりすぎないよう工夫しました。事業紹介ではコンテンツごとに枠組みして文字の大きさ、余白を意識し、文章が多くても読みやすいデザインしました。"
  ...
  pf: {
    ...
    info: {
      ...
      period: "<br>70時間（企画 / デザイン / コーディング/写真）",
    ...
    steps: [
      ...
      {
        title: "ワイヤーフレーム作成",
        img: "./images/originalpf-wireframe.png",
        text: "開いた瞬間面白い印象を与えられるよう、コンテンツ間の背景色の切り替えに流形シェイプを使用しました。自分の個性と情報の伝わりやすさの両立を目指し近接、整列を意識しました。"


      },
      {
        title: "デザインカンプ作成",
        img: "./images/originalpf-designcomp.png",
        text: "情報の見やすさ、探しやすさを第一にデザインをブラッシュアップしました。workページでは感覚的に操作できるようカテゴリ分け、検索ができる設計にしました。また、視認性を上げるため、aboutページではスキルと使用可能ツールを同じ枠組みでまとめました。"
      },
      {
        title: "Web制作・コーディング",
        img: "./images/originalpf-coding.png",
        text: "更新しやすくするため、TOPページ、Worksページの実績紹介ではhtmlで1つ型を作り、jsで情報を差し替える実装を行いました。見たい情報に少ない手順でたどり着けるよう、作品画像をクリック→作品詳細に飛ぶ、すべて見るボタンをクリック→作品一覧に飛ぶ、など画面遷移の方法もこだわりました。"
      }
    ],
  ...
  tousai: {
    ...
    steps: [
      ...
      {
        title: "デザインカンプ作成",
        img: "./images/LP-designcomp.png",
        text: "伝えたい情報が一目で伝わるデザインを目指しました。数字を大きく表示することで説得力を高め、ページのどこを見ていてもCTAボタンが押せる設計にしました。IT業界の知的で洗礼されたイメージを表現するため、ベースカラーは彩度低めの色でまとめました。一方で、CTAボタンはやる気や熱意を感じる再度高めのオレンジを設定し目立たせました。"
      },
      {
        title: "Web制作・コーディング",
        img: "./images/coming-soon.png",
